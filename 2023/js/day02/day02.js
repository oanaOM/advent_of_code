...
function partOne(data) {
    ...
    formattedData.map(function (g) {
        ...
        if (highestNumberInAllGames === 13) {
            var row = games.find(function (g) { return g.includes(13); });
        ...
        if (highestNumberInAllGames === 14) {
            var row = games.find(function (g) { return g.includes(14); });
    ...
    return validGames.reduce(function (acc, value) { return parseInt(acc) + parseInt(value); });
}
